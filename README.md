...
```
~# wget https://raw.githubusercontent.com/ThomasHack/PVEDiscordDark/master/PVEDiscordDark.sh
~# bash PVEDiscordDark.sh install
```
Or this oneliner
```
bash <(curl -s https://raw.githubusercontent.com/ThomasHack/PVEDiscordDark/master/PVEDiscordDark.sh ) install
```
...
`REPO` is in format `Username/Repository` and defaults to `ThomasHack/PVEDiscordDark` (this repository).    
